...
import com.mall.pay.model.builder.*;
import com.mall.pay.model.hb.*;
    ...
    public void test_trade_precreate() {
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("C:/Users/96575/Desktop/alipay/qr-%s.png",
